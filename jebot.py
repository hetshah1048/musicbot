...
async def song(client, message):
  ...
  # also splitting text for correct yt search
    ...
    status = await message.reply(
             text="<b>Downloading your song, Plz wait 🥺\n\nMade by @Luciferrr_xD</b>",
             disable_web_page_preview=True,
                        reply_markup=InlineKeyboardMarkup(
                            [[
                                    InlineKeyboardButton(
                                        "Developer", url="https://t.me/Luciferrr_xD")
                                ]]
                        ),
               parse_mode="html",
...
Hit help button to find out more about how to use me</b>""",   
                            reply_markup=InlineKeyboardMarkup(
                                [[
                                        ...
                                        InlineKeyboardButton(
                                            "Contact My Owner To Approve You To Access Me", url="https://t.me/Luciferrr_xD")
                                    ]]
                            ),        
            disable_web_page_preview=True,        
            parse_mode="html",
